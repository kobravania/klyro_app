...
echo "   railway variables set BOT_TOKEN=8515314140:AAHdCnEUIxYRoJqRRA9k5byj2wbXMj79C_Y"
...
echo "   curl \"https://api.telegram.org/bot8515314140:AAHdCnEUIxYRoJqRRA9k5byj2wbXMj79C_Y/setWebhook?url=ВАШ_RAILWAY_URL/webhook\""
echo ""
